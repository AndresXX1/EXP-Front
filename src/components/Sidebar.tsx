  ...
  return (
    <div className="flex w-[285px] font-book">
      <div className="bg-expresscash-white w-[285px] fixed">
          ...
          {links.map((link, index) => (
            <li
              ...
              className={`flex h-12 pl-3 gap-3 ${
                currentPath === link.to
                  ? "text-expresscash-skyBlue border-l-8 pl-6 border-expresscash-skyBlue"
                  : "text-expresscash-textos border-l-8 border-transparent pl-6"
              }`}
            >
        ...
        <div className="mt-12 flex items-center justify-center border-[2px] border-expresscash-textos w-[66px] h-[66px] mx-auto rounded-[15px]">
      ...
      <div className="fixed ml-[280px] z-[1] bg-expresscash-gray2 w-[1px] h-full"></div>
    </div>
  );
};
