    ...
    <>
      ...
      <div className="modal">
        <div className="modal-content">
          <div className="flex justify-between items-center">
            <p className="text-[32px] text-Express-Cash-textos font-bold">Editar producto</p>
            ...
            <div className="flex gap-12">
              ...
              <div className="flex flex-col gap-4">
                ...
                <textarea
                  ...
                  className="w-[617px] h-[181px] text-[16px] font-book p-3 text-Express-Cash-textos align-top border border-Express-Cash-gray rounded-[5px] resize-none placeholder:text-Express-Cash-gray"
                ...
                <div className="flex gap-2 items-center">
                  ...
                  />
                  <span className="text-Express-Cash-textos font-bold text-[14px]">
                    Incluir envío
                  </span>
                </div>
                ...
                <div className="flex gap-4 mt-8">
                  <button
                    onClick={handleSave}
                    className="bg-Express-Cash-red w-[150px] h-[50px] rounded-[5px] text-Express-Cash-white text-[16px] font-book"
                  >
                    Guardar cambios
                  </button>
                  <button
                    onClick={closeModal}
                    className="border-[1px] border-solid border-Express-Cash-gray w-[150px] h-[50px] rounded-[5px] text-Express-Cash-gray text-[16px] font-book"
                  >
                    Cancelar
                  </button>
                </div>
