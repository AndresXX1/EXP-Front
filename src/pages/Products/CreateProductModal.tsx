          ...
          <div className="mt-5">
            <div className="flex gap-12">
              <div>
                ...
                <p className="pt-9 pb-4 text-[14px] font-bold text-expresscash-textos">
                  Incluye envío
                </p>
                <div className="flex gap-5">
                  <div className="flex items-center gap-3 rounded-[4px]">
                    <p>Si</p>
                    <input
                      className="border-[1px] border-solid border-expresscash-gray rounded-[4px]"
                      type="checkbox"
                ...
                <div className="w-[17px] h-[17px] rounded-full bg-expresscash-skyBlue"></div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <textarea
                  ...
                  className={`w-[617px] h-[181px] text-[16px] font-book p-3 text-expresscash-textos align-top border ${errors.description ? "border-red-500" : "border-expresscash-gray"} rounded-[5px] resize-none placeholder:text-expresscash-textos`}
