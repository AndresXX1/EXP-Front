          ...
          element={
            <div className="space-y-4 max-w-4xl mx-auto p-6">
              ...
              <input
                ...
                className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${errors.street ? 'border-red-500' : 'border-Express-Cash-gray'}`}
              ...
              {errors.street && <p className="text-red-500 text-xs w-[300px]">{errors.street}</p>}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${errors.number ? 'border-red-500' : 'border-Express-Cash-gray'}`}
                    placeholder="Ej: 825"
                  />
              ...
              <div className="grid grid-cols-2 gap-x-4 ml-10">
                <div>
                  ...
                  <input
                    ...
                    className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${errors.zipCode ? 'border-red-500' : 'border-Express-Cash-gray'}`}
                ...
                <input
                  ...
                  className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${errors.city ? 'border-red-500' : 'border-Express-Cash-gray'}`}
        ...
        <div className="grid grid-cols-3 gap-x-4 ml-10">
          <div className="col-span-3">
            ...
            <select
              ...
              className={`w-[617px] h-[54px] rounded-[5px] border-[1px] border-solid ${errors.province ? 'border-red-500' : 'border-Express-Cash-gray'}`}
              autoComplete="off" 
            >
  ...
  />
        ...
        <div className="space-y-4 max-w-5xl mx-auto p-6 w-[552px] max-h-[80vh] overflow-y-auto">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-Express-Cash-skyBlue text-white rounded-md hover:bg-blue-600 mb-4 translate-x-[130px]"
          >
            <IconEdit />
            Agregar Dirección
          </button>
          ...
          {addresses.length === 0 ? (
            ...
            addresses.map((address, index) => (
              <div key={index} className="border rounded-lg p-4 mb-4 relative">
                ...
                <p className="text-smb text-Express-Cash-skyBlue"> Domicilio {index + 1}</p>
