        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-[0.7fr_1fr_1fr] gap-4">
            <div className="w-[144px] translate-y-[35px] translate-x-[40px]">
              <div className="rounded-[11px] w-[140px] h-[152px] bg-Express-Cash-gray3 border border-Express-Cash-gray2 mb-12">
              <img
...
/>
            ...
            <div className="col-span-2 grid grid-cols-2 gap-x-6 gap-y-2.5 mt-2.5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${formErrors.firstName ? 'border-red-500' : 'border-Express-Cash-gray'}`}
                  />
              ...
              <div>
                ...
                <input
                  ...
                  onPaste={handlePaste}
                  onChange={handleInputChange}
                  className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${formErrors.lastName ? 'border-red-500' : 'border-Express-Cash-gray'}`}
                />
              ...
              <input
                ...
                className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${formErrors.phone ? 'border-red-500' : 'border-Express-Cash-gray'}`}
              />
  ...
  <input
    ...
    className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${formErrors.cuil ? 'border-red-500' : 'border-Express-Cash-gray'}`}
  />
  {formErrors.cuil && <p className="text-red-500 text-xs mt-1">{formErrors.cuil}</p>}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-[300px] h-[54px] rounded-[5px] border-[1px] border-solid ${formErrors.birthday ? 'border-red-500' : 'border-Express-Cash-gray'}`}
                />
...
<div>
            ...
            <button
              onClick={handleSave}  
              className="bg-Express-Cash-skyBlue w-[109px] h-[38px] rounded-[5px] text-Express-Cash-white text-[1rem] font-book hover:bg-argentpesos-blue hover:transition-colors duration-100"
