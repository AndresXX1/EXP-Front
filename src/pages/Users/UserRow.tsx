      ...
      <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr] gap-6 relative items-center justify-start">
        <div className="flex items-center gap-1 self-center">
          <img
            ...
            alt={user.first_name}
          />
          <p className="text-[1rem] text-expresscash-textos font-book text-left self-center">
        ...
        <button
          ...
          className={`text-[0.9rem] font-book border-[2px] rounded-full py-[4px] w-[80%] ${user.cuponizate ? "text-expresscash-skyBlue" : "text-expresscash-textos"}`}
        >
          {user.cuponizate ? "Activo" : "Inactivo"}
        </button>

        <p className="text-[1rem] text-expresscash-textos font-book text-center">
          {calculateAge(user.birthday) || "-"}
        </p>
        <p className="text-[1rem] text-expresscash-textos font-book text-center">
          {user.points || "-"}
        </p>
        <p className="text-[0.9rem] text-expresscash-textos font-book text-center">
          {formatDateString(user.create).slice(0, 13) || "-"}
        </p>
        <p className="text-[1rem] text-expresscash-textos font-book text-center translate-x-5">
        ...
        <div className="w-[114%] h-[1px] bg-expresscash-gray mt-5 col-span-6 mb-10 -ml-[5%]"></div>
      </div>
