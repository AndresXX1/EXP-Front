  ...
  return (
    <div className="flex flex-col pl-16 pt-12 px-10 max-w-[clamp(1000px,77.2vw,1200px)]">
      ...
      <div className="flex gap-2 mb-2">
        <p className="text-[3rem] text-Express-Cash-textos font-bold">Usuarios</p>
        <p className="text-[40px] text-Express-Cash-textos font-book mt-[6px]">
      ...
      <div className="flex justify-between mb-8">
        <div className="relative flex">
          ...
          <div className="flex w-[120px] h-[54px] ml-4 border-[1px] border-Express-Cash-textos items-center justify-center gap-2 rounded-[13px]">
            <IconFilter />
            <p className="text-[15.36px] font-book text-Express-Cash-textos">Filtros</p>
          </div>
        </div>
        <div className="flex gap-20 items-center">
          <p className="text-Express-Cash-textos">
      ...
      <div className="grid grid-cols-6 gap-8 mb-10 bg-gray-100 p-16 rounded-t-lg items-center w-[1240px] translate-x-[-40px]">
        <div className="font-bold text-Express-Cash-textos text-center ">Usuarios</div>
        <div className="font-bold text-Express-Cash-textos text-center translate-x-14">Cuponizate</div>
        <div className="font-bold text-Express-Cash-textos text-center translate-x-9">Edad</div>
        <div className="font-bold text-Express-Cash-textos text-center ">Puntos</div>
        <div className="font-bold text-Express-Cash-textos text-left translate-x-1 ">Registrado</div>
        <div className="cursor-pointer flex items-center justify-left" onClick={toggleSortOrder}>
        <div className="font-bold text-Express-Cash-textos text-center translate-x-5">Estado</div>
