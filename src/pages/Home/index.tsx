...
const Home = () => {
  ...
  return (
    <div className="flex flex-col pl-16 pt-12 px-10 h-[100%]">
      <p className="text-[46.08px] text-Express-Cash-textos font-bold">
        Hola{" "}
        <span className="text-Express-Cash-skyBlue">
          {user?.full_name || "Usuario"}
        </span>
      </p>
      <p className="text-[19.2px] text-Express-Cash-gray font-book">
      ...
      <div className="flex gap-5 pt-5">
        <div className="relative">
          <input
            className="w-[457px] h-[54px] rounded-[13px] border-[1px] border-Express-Cash-textos border-solid px-10 placeholder:text-Express-Cash-textos font-book text-Express-Cash-textos text-[15.36px]"
            type="search"
            placeholder="Buscar estadísticas o datos"
          />
          <IconMagnifyingGlass className="absolute top-[18px] left-4" />
        </div>
        <div className="flex w-[127px] h-[54px] ml-4 border-[1px] border-Express-Cash-textos flex- items-center justify-center gap-2 rounded-[13px]">
          <p className="text-[15.36px] font-book text-Express-Cash-textos">
            Semanal
          </p>
          <ArrowLeft className="w-[7px] h-[20px] rotate-[270deg]" />
        </div>
        <button className="flex gap-2 w-[291px] h-[54px] items-center justify-center bg-Express-Cash-skyBlue text-[1rem] text-Express-Cash-white font-book rounded-[13px] hover:bg-Express-Cash-blue hover:transition-colors duration-100">
          <IconDownload />
          Descargar planillla
        </button>
      </div>
      <p className="flex items-center gap-[6px] pt-5 text-Express-Cash-gray text-[15.36px] font-book">
        {" "}
        <div className="w-[10.56px] h-[10.56px] bg-Express-Cash-green rounded-full bg-opacity-[0.7]"></div>
        {getFormattedDate()}
        <IconArrows />
      </p>

      <div className="grid grid-cols-3 grid-rows-5 gap-5 pt-5 pb-10">
        <div className="border-[1px] border-Express-Cash-gray col-span-1 h-[207px] rounded-[13px] px-5 py-5">
          <div className="flex gap-3 items-center pb-5">
            <IconUser color="#C4C4C4" />
            <p className="text-[22px] font-bold text-Express-Cash-textos">
              Usuarios activos
            </p>
          </div>

          <p className="text-[46.08px] font-bold text-Express-Cash-textos mb-4">
          ...
          <div className="flex gap-2 items-center">
            ...
            <p className="text-[22px] text-Express-Cash-gray2 font-book">
              esta semana
            </p>
          </div>
        </div>
        ...
        <div className="border-[1px] border-Express-Cash-gray col-span-2 h-[207px] rounded-[13px] p-4">
          <div className="flex gap-3 items-center pb-5">
            <IconUserMore />
          ...
          <div className="flex gap-5">
            <div className="flex flex-col gap-[13px]">
              <p className="text-Express-Cash-gray2 text-[9.6px] font-book">
                200k
              </p>
              <p className="text-Express-Cash-gray2 text-[9.6px] font-book">
                150k
            ...
            <div className="grid grid-cols-8 grid-rows-3 w-[90%] relative">
              ...
              <div className="absolute bg-Express-Cash-blue w-[7.68px] h-[7.68px] rounded-[4px] top-[2.1rem] right-[16.25rem]"></div>
            </div>
          </div>
          <div className="px-[22px] pt-3 flex gap-7">
            {date.map((inf, key) => (
              <div className="flex" key={key}>
                <p className="text-[9.6px] text-Express-Cash-textos font-book">
                  {inf.info}
                </p>
              </div>
            ))}
        ...
        <div className="border-[1px] border-Express-Cash-gray row-span-2 h-[435px] rounded-[13px] p-5">
          ...
          <p className="text-[20px] text-Express-Cash-textos font-book">Edad</p>
          <div className="flex gap-[22px] items-center">
            <p className="text-[15.36px] font-book text-Express-Cash-gray2">
              18-30
            </p>
            <div
              className="bg-Express-Cash-skyBlue rounded-[4.9px] h-[13.44px]"
              style={{
                width: `${Math.round(progress_18_30)}%`,
              }}
            ></div>
            <p className="text-Express-Cash-textos text-[15.36px] font-book">
              {progress_18_30}%
            </p>
          </div>
          ...
          <div className="flex gap-8 items-center">
            <p className="text-[15.36px] font-book text-Express-Cash-gray2">{`>60     `}</p>
            <div
              className="bg-Express-Cash-skyBlue rounded-[4.9px] h-[13.44px]"
              style={{
          ...
          <p className="text-[20px] text-Express-Cash-textos font-book pt-3">
            Género
          </p>
          <div className="flex flex-row mt-3">
            <div className="flex w-[60%] gap-2">
              ...
              <div className="bg-Express-Cash-blue w-[80%] h-[25px] text-[11.52px] flex items-center px-2 font-book text-Express-Cash-white rounded-s-lg">
                44%
              </div>
            </div>
            <div className="flex w-[60%] gap-2">
              <div className="bg-Express-Cash-skyBlue w-[100%] h-[25px] text-[11.52px] flex items-center px-2 font-book text-Express-Cash-white rounded-e-lg">
                56%
              </div>
              <p className="text-Express-Cash-textos text-[15.36px] font-book">
                M
          ...
          {/* <p className="text-[20px] text-Express-Cash-textos font-book pt-3 pb-3">
            Ubicación
          </p>
          <div className="flex gap-5 justify-center relative">
            ...
            <div className="flex flex-col justify-end items-center">
              <div className="w-[13px] bg-Express-Cash-skyBlue rounded-[4.9px] h-[50px]"></div>
              <p className="text-[9.6px] font-book text-Express-Cash-textos mt-1">
                AMBA
              </p>
            ...
            <div className="flex flex-col items-center justify-end">
              <div className="h-[40%] w-[13px] bg-Express-Cash-skyBlue rounded-[4.9px]"></div>
              <p className="text-[9.6px] font-book text-Express-Cash-textos mt-1">
                CABA
              </p>
              <p className="text-Express-Cash-textos text-[15.36px] font-book">
            ...
            <div className="flex flex-col justify-end items-center">
              <div className="h-[25%] w-[13px] bg-Express-Cash-skyBlue rounded-[4.9px]"></div>
              <p className="text-[9.6px] font-book text-Express-Cash-textos mt-1">
                Bs As.
              </p>
              <p className="text-Express-Cash-textos text-[15.36px] font-book">
            ...
            <div className="flex flex-col justify-end items-center">
              <div className="h-[20%] w-[13px] bg-Express-Cash-skyBlue rounded-[4.9px]"></div>
              <p className="text-[9.6px] font-book text-Express-Cash-textos mt-1">
                Jujuy
              </p>
              <p className="text-Express-Cash-textos text-[15.36px] font-book">
        ...
        <div className="border-[1px] border-Express-Cash-gray col-span-2 h-[207px] rounded-[13px] p-4">
          <div className="flex gap-3 items-center pb-5">
            ...
            <div className="flex w-[179px] h-[28px] ml-4 border-[1px] border-Express-Cash-textos flex- items-center justify-center gap-2 rounded-[8px]">
              <p className="text-[15.36px] font-book text-Express-Cash-textos">
                Tiempo promedio
              </p>
          ...
          {viewTop.map((item, key) => {
            ...
            return (
              <div className="flex items-center gap-1" key={`${key}=view`}>
                <p className="text-[9.6px] text-Express-Cash-textos font-bold">
                  {`#0${key + 1}`}
                </p>
                <p className="text-[9.6px] text-Express-Cash-textos font-book mb-1 pr-14">
                  {capitalizeFirstLetter(item[0])}
                </p>
                <div
                  className={`h-[13.44px] rounded-[4.8px] mr-2 ${
                    item[0] === "home"
                      ? "bg-Express-Cash-skyBlue"
                      : item[0] === "profile"
                        ? "bg-[#F3E670]"
                        : item[0] === "argencompras"
                          ? "bg-[#F47666]"
                ...
                ></div>
                <p className="text-[15.36px] mr-1 font-bold text-Express-Cash-textos">
                ...
                <ColorfulText
                  ...
                  fontSize="9.6px"
                />
                <p className="text-[9.6px] ml-1 text-Express-Cash-gray2 font-book">
                  esta semana
                </p>
              </div>
            );
        ...
        <div className="border-[1px] border-Express-Cash-gray col-span-1 h-[207px] rounded-[13px] px-5 py-5">
          ...
          <p className="text-[46.08px] font-bold text-Express-Cash-textos mb-4">
            $11m
            <span className="text-[22px] font-book text-Express-Cash-textos ml-2">
              solicitados
            </span>
          </p>
