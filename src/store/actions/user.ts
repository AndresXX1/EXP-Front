...
export const createAddressAsync = createAsyncThunk(
  "address/create",
  async (
    { userId, address }: { userId: number; address: NewAddress },
    { rejectWithValue }
  ) => {
    try {
      ...
      return rejectWithValue(
        error.message || "Ocurrió un error al crear la dirección"
      );
    }
  }
);
  ...
  async (
    {
      ...
      index,
      updatedAddress,
    }: { userId: number; index: number; updatedAddress: NewAddress },
    { rejectWithValue }
  ) => {
    try {
...
export const deleteAddressAsync = createAsyncThunk(
  "address/delete",
  async (
    { userId, index }: { userId: number; index: number },
    { rejectWithValue }
  ) => {
    try {
...
export const blockUserAsync = createAsyncThunk(
  ...
  async (userId: number, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.message || "Ocurrió un error al bloquear al usuario"
      );
    }
  }
);
...
export const unblockUserAsync = createAsyncThunk(
  ...
  async (userId: number, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.message || "Ocurrió un error al desbloquear al usuario"
      );
    }
  }
);
